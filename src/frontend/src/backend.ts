...
import type { Lesson as _Lesson, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getLessonContent(arg0: string, arg1: string): Promise<Lesson | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessonContent(arg0, arg1);
    ...
    async getQuestions(arg0: string, arg1: string): Promise<Array<Question>> {
        if (this.processError) {
            try {
    ...
    async submitQuizResult(arg0: string, arg1: string, arg2: bigint, arg3: bigint): Promise<QuizResult> {
        if (this.processError) {
            try {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Lesson]): Lesson | null {
